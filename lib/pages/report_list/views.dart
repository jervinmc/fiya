              ...
              child: new ListView.separated(
                ...
                itemBuilder: (BuildContext context, int index) {
                  return InkWell(
                    child: new ListTile(
                      onTap: () async {
                        if (data[index]['title'] == 'Closed ticket') {
                          return;
                        }
                        var params1 = {"is_viewed": "yes"};

                        final response1 = await http.patch(
                            Uri.parse(BASE_URL_REPORT +
                                '' +
                                data[index]['id'].toString() +
                                '/'),
                            headers: {"Content-Type": "application/json"},
                            body: json.encode(params1));
                              ...
                              child: Card(
                                  ...
                                  child: Container(
                                      ...
                                      child: Column(
                                        children: [
                                          Text(
                                              "Ticket - #${data[index]['id']} - ${data[index]['title']}"),
                                          data[index]['is_viewed'] == 'no'
