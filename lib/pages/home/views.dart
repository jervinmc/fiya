                  ...
                  elevation:10,
                    child: Column(
                      ...
                      children: [
                          ...
                          child: Column(
                          children: [
                                Text('From L: CHED Executive Director Atty. Cinderella Filipina S. Benitez-Jaro, Dr. Ma. Agnes P. Nuestro, Dr. Adolfo C, Manuel Jr., and CHEDRO Directors Maximo C. Aljibe and Marco Cicero F. Domingo.',style:TextStyle(fontSize:13.0)),
                        ...
                        Container(
                          ...
                          child: Column(
                          children: [
                                Text('CHED confers Gawad Parangal sa Kahusayan – COPC Award to CvSU',style:TextStyle(fontSize:25.0,fontWeight:FontWeight.bold)),
                        ...
                        Container(
                         ...
                         Container(
                          ...
                          child: Column(
                            children:[
                              Text('The trophy of recognition was received by Dr. Ma. Agnes P. Nuestro, Officer In-Charge (OIC) at the Office of the University President and the current Vice President for Academic Affairs and Dr. Adolfo C. Manuel Jr., Director for Institutional Development.',style:TextStyle(fontSize:13.0))
                            ]
                          )
                        ),
                          Container(
                          ...
                          child: Column(
                            children:[
                              Text('The Commission conducted the 2022 Gawad Parangal as part of the 2nd National Higher Education Day and CHED’s 28th founding anniversary celebration with the theme “Claiming Victory for Quality Higher Education: Dekalidad Na Edukasyon, Karapatan Ng Mamamayan”.',style:TextStyle(fontSize:13.0))
                            ]
                          )
                        ),
                         Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          [
                             Text('In honor and recognition of the 2022 civil engineering board topnotcher, new set of architects, electronics, electrical, and civil engineers, and electronics and master technicians, a tribute program sponsored by the College of Engineering and Information Technology (CEIT) was held on 23 May 2022 at the International Convention Center.',style:TextStyle(fontSize:13.0))
                          ]),
                        ),
                        Container(
                          padding:EdgeInsets.all(10),
                        ...
                        Container(
                          ...
                          child:  Column(children:
                          [
                             Text('This collaboration applicable in the current flexible learning arrangement not only gives the students a chance to receive global education but also opens doors of international collaboration and engagement for other teachers. (LAOrsal)',style:TextStyle(fontSize:13.0))
                          ]),
                        ),
                        Container(
                          padding:EdgeInsets.all(10),
                    ...
                    child: Column(
                      ...
                      Container(
                        ...
                        Container(
                          ...
                          child:  Column(children:
                          [
                             Text('With this year’s theme of “Embracing Sports Excellence in the New Normal,” 34 CvSU athletes from the main and satellite campuses represented the University in the sports event. They were accompanied by 9 coaches and 11 committee members.',style:TextStyle(fontSize:13.0,))
                          ]),
                        ),
                        Container(
                          padding:EdgeInsets.all(10),
                        ...
                        Container(
                          ...
                          child:  Column(children:
                          [
                             Text('The futsal women, coached by Ms. Clarisse Ann Papa, contributed three gold medals while the badminton players (women’s singles A and B), who were coached by Mr. Rey-an Penus, added one gold medal each.',style:TextStyle(fontSize:13.0))
                          ]),
                        ),
                        Container(
                          padding:EdgeInsets.all(10),
                          child:  Column(children:
                          [
                             Text('The three silver medals were from women’s basketball (3×3), coached by Ms. Yzzabel Mojica, while the bronze medals were from futsal (3), badminton (1), chess board 2 (1), all under the men’s division, and one from chess women’s division (Board 2).',style:TextStyle(fontSize:13.0))
                          ]),
                        ),
                        Container(
                          padding:EdgeInsets.all(10),
                          child:  Column(children:
                          [
                             Text('Eleven State Universities and Colleges (SUCs) in Regions IV-A and B participated in the olympics. Palawan State University (PSU) was hailed champion while Batangas State University (BatSU) was declared first runner-up.',style:TextStyle(fontSize:13.0))
                          ]),
                        ),
                  ...
                  elevation:10,
                    child: Column(
                      ...
                      children: [
                          ...
                          child:  Column(children:
                          [
                             Text('The heirs of Don Severino Delas Alas with the CvSU Vice Presidents.',style:TextStyle(fontSize:13.0))
                          ]),
                        ),
                        Container(
                          padding:EdgeInsets.all(10),
                          child: Column(
                          children: [
                                Text('Resiliency amidst the pandemic: CvSU celebrates 116th founding anniversary',style:TextStyle(fontSize:25.0,fontWeight:FontWeight.bold)),
                       ...
                       Container(
                          ...
                          child:  Column(children:
                          [
                             Text('In celebration of 116 years of being truthful and excellent in service, Cavite State University held its founding anniversary by honoring the legacy of Don Severino Delas Alas, recognizing the loyalty of CvSU employees, and marking its new milestone.',style:TextStyle(fontSize:13.0))
                          ]),
                        ),
                        Container(
                          padding:EdgeInsets.all(10),
