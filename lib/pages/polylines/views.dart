                        ...
                        : category_select == 'University Registrar'
                            ...
                            : category_select == 'University Library'
                                ...
                                : category_select ==
                                    ...
                                    : category_select == 'College of Nursing'
                                        ? Column(
                                            crossAxisAlignment:
                                                CrossAxisAlignment.start,
                                            children: [
                                                            ...
                                                            : category_select ==
                                                                ...
                                                                : category_select ==
                                                                    ...
                                                                    ? Column(
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                              'Dean - Dr. Analita dM. Magsino'),
                                                                          Text(
                                                                              'Chairperson, Department of Animal Science	 - Dr. Cristina F. Olo'),
                                                                          Text(
                                                                              'Chairperson, Department of Crop Science - Dr. Adelaida E. Sangalang'),
                                                                          Text(
                                                                              'Chairperson, Department of Environmental Science - Ms. Amyel Dale L. Cero'),
                                                                          Text(
                                                                              'Chairperson, Department of Agricultural Entrepreneurship - Mr. Edgardo A. Gonzales'),
                                                                          Text(
                                                                              'Chairperson, Institute of Food Science and Technology - Mr. Jason D. Braga'),
                                                                          Text(
                                                                              'Research & Knowledge Management Coordinator - Dr. Mariedel L. Autriz'),
                                                                          Text(
                                                                              'Quality Assurance Coordinator - Dr. Cristina F. Olo'),
                                                                          Text(
                                                                              'GAD Coordinator & Guidance Facilitator - Ms. Jo-an T. Ducducan'),
                                                                          Text(
                                                                              'Registrar - Ms. Jo-an T. Ducducan'),
                                                                          Text(
                                                                              'Extension Coordinator - Ms. Ma. Cecille N. Basa'),
                                                                          Text(
                                                                              'Budget Officer - Dr. Adelaida E. Sangalang'),
                                                                          Text(
                                                                              'On-The-Job Training Coordinator (Food Technology) - Mr. Jason D. Braga'),
                                                                          Text(
                                                                              'Entrepreneurial Development Project Coordinator (Agricultural Entrepreneurship) - Mr. Edgardo A. Gonzales'),
                                                                          Text(
                                                                              'MIS/Public Information Officer - Ms. Amyel Dale L. Cero'),
                                                                          Text(
                                                                              'Instructional Materials Development Coordinator - Dr. Evelyn O. Singson'),
                                                                        ],
                                                                      )
                                                                    : Text('')
              ]))
